...
<?php if (\app\Session::isAdmin()): ?>
    ...
    <ul>
        <li><a href="index.php?ctrl=security&action=listUsers">Gérer les utilisateurs</a></li>

        <li><a href="index.php?ctrl=security&action=listTopics">Gérer les topics</a></li>
        <li><a href="index.php?ctrl=security&action=listPosts">Gérer les posts</a></li>
    </ul>
    <?php endif; ?>
